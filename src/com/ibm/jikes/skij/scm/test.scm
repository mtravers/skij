...
(defmacro (test . args)
  `(begin
     (define res (catch (test1 ,@args)))
     (if (instanceof res 'java.lang.Throwable)
	 (display (string-append "ERROR: " (string res) "\n")))))
...
(SECTION 3 4)
(number? 23)				;skij: autoload
(symbol? 'foo)				;skij: autoload
...
;skij - runs out of memory from circularity
...
;skij --- this won't work
(string-set! x 0 #\c)
(test "cb" 'string-set! x)
(test "ab" symbol->string y)
(test y string->symbol "ab")

;skij -- this is an incompatibility
