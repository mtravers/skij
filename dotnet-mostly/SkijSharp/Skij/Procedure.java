...
public abstract class Procedure {
  ...
  public void define(Environment env) {
    ...
    // .NET stuff - this delegate nonsense is a pain
    public Object ThreadStartDelegate() {
	Object foo = new System.Threading.ThreadStart(apply0);
	return foo;
    }

    public void apply0() throws SchemeException {
	apply(Nil.nil);
    }
